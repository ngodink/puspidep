...
--
-- Host: localhost:3306
-- Generation Time: Feb 03, 2020 at 09:32 AM
...
--
-- Table structure for table `ref_achievement_nums`
--

CREATE TABLE `ref_achievement_nums` (
  `id` tinyint(3) UNSIGNED NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `ref_achievement_nums`
--

INSERT INTO `ref_achievement_nums` (`id`, `name`) VALUES
(1, 'JUARA 1'),
(2, 'JUARA 2'),
(3, 'JUARA 3'),
(4, 'JUARA HARAPAN 1'),
...
--
-- Table structure for table `ref_achievement_types`
--

CREATE TABLE `ref_achievement_types` (
  `id` tinyint(3) UNSIGNED NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `ref_achievement_types`
--

INSERT INTO `ref_achievement_types` (`id`, `name`, `description`) VALUES
(1, 'AKADEMIK', 'Lomba olimpiade bidang studi, kompetisi sains madrasah, cerdas cermat, dll'),
(2, 'KEAGAMAAN', 'Lomba baca/hafalan al Qur\'an, kaligrafi, adzan, dll.'),
(3, 'TEKNOLOGI', 'Lomba robotik, perancangan web atau sistem informasi, perakitan mesin, dll'),
(4, 'OLAHRAGA', 'Lomba bela diri, sepakbola, bola basket, bulutangkis, catur, tenis meja, bola voli, dll'),
(5, 'PRAMUKA/PASKRIBAKA', NULL),
(6, 'KARYA ILMIAH REMAJA', NULL),
(7, 'KESENIAN', 'Lomba menyanyi, menari, melukis, alat musik, marching band, dll'),
(8, 'PIDATO BAHASA ASING', 'Lomba pidato bahasa inggris, bahasa mandarain, bahasa arab, dll'),
(9, 'LAIN-LAIN', NULL);
...
CREATE TABLE `ref_countries` (
  ...
  `kd` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `ref_countries` (`id`, `kd`, `name`) VALUES
(1, 'AF', 'AFGHANISTAN'),
(2, 'AX', 'ÅLAND ISLANDS'),
(3, 'AL', 'ALBANIA'),
(4, 'DZ', 'ALGERIA'),
...
--
-- Table structure for table `ref_creation_ctgs`
--

CREATE TABLE `ref_creation_ctgs` (
  `id` tinyint(4) UNSIGNED NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `ref_creation_ctgs`
--

INSERT INTO `ref_creation_ctgs` (`id`, `name`) VALUES
(1, 'KARYA ILMIAH'),
(2, 'BUKU'),
(3, 'NOVEL'),
(4, 'JURNAL'),
...
--
-- Table structure for table `ref_desires`
--

CREATE TABLE `ref_desires` (
  `id` tinyint(3) UNSIGNED NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `ref_desires`
--

INSERT INTO `ref_desires` (`id`, `name`) VALUES
(1, 'PNS'),
(2, 'TNI/POLRI'),
(3, 'GURU/DOSEN'),
(4, 'DOKTER'),
...
--
-- Table structure for table `ref_disabilities`
--
...
--
-- Dumping data for table `ref_disabilities`
--
...
--
-- Table structure for table `ref_employments`
--
...
--
-- Dumping data for table `ref_employments`
--
...
--
-- Table structure for table `ref_grade_levels`
--

CREATE TABLE `ref_grade_levels` (
  `id` tinyint(3) UNSIGNED NOT NULL,
  `grade_id` tinyint(3) UNSIGNED NOT NULL,
  `kd` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rome` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `ref_grade_levels`
--

INSERT INTO `ref_grade_levels` (`id`, `grade_id`, `kd`, `rome`, `name`) VALUES
(1, 3, '1', 'I', 'SATU'),
(2, 3, '2', 'II', 'DUA'),
(3, 3, '3', 'III', 'TIGA'),
(4, 3, '4', 'IV', 'EMPAT'),
...
(10, 5, '10', 'X', 'SEPULUH'),
(11, 5, '11', 'XI', 'SEBELAS'),
(12, 5, '12', 'XII', 'DUABELAS');

-- --------------------------------------------------------

--
-- Table structure for table `ref_habitations`
--

CREATE TABLE `ref_habitations` (
  `id` tinyint(3) UNSIGNED NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `ref_habitations`
--

INSERT INTO `ref_habitations` (`id`, `name`) VALUES
(1, 'RUMAH ORANGTUA'),
...
--
-- Table structure for table `ref_hobbies`
--
...
--
-- Dumping data for table `ref_hobbies`
--

INSERT INTO `ref_hobbies` (`id`, `name`) VALUES
(1, 'OLAHRAGA'),
(2, 'KESENIAN'),
(3, 'MEMBACA'),
(4, 'MENULIS'),
...
--
-- Table structure for table `ref_organization_positions`
--

CREATE TABLE `ref_organization_positions` (
  `id` tinyint(4) UNSIGNED NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `ref_organization_positions`
--

INSERT INTO `ref_organization_positions` (`id`, `name`) VALUES
(1, 'KETUA'),
(2, 'WAKIL KETUA'),
(3, 'SEKRETARIS'),
(4, 'BENDAHARA'),
...
INSERT INTO `ref_organization_types` (`id`, `name`) VALUES
(1, 'PENDIDIKAN'),
(2, 'SOSIAL'),
(3, 'PERNIAGAAN'),
(4, 'REGIONAL'),
...
--
-- Table structure for table `ref_periods`
--

CREATE TABLE `ref_periods` (
  `id` tinyint(3) UNSIGNED NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `ref_periods`
--

INSERT INTO `ref_periods` (`id`, `name`, `year`) VALUES
(1, '1975-1976', 1975),
(2, '1976-1977', 1976),
(3, '1977-1978', 1977),
(4, '1978-1979', 1978),
...
INSERT INTO `ref_provinces` (`id`, `name`) VALUES
(11, 'ACEH'),
(12, 'SUMATERA UTARA'),
(13, 'SUMATERA BARAT'),
(14, 'RIAU'),
...
--
-- Table structure for table `ref_province_regencies`
--

CREATE TABLE `ref_province_regencies` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `ref_province_regencies`
--

INSERT INTO `ref_province_regencies` (`id`, `province_id`, `name`) VALUES
...
--
-- Table structure for table `ref_province_regency_districts`
--

CREATE TABLE `ref_province_regency_districts` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `ref_province_regency_districts`
--

INSERT INTO `ref_province_regency_districts` (`id`, `regency_id`, `name`) VALUES
...
--
-- Table structure for table `ref_salaries`
--
...
--
-- Table structure for table `ref_territories`
--
...
--
-- Dumping data for table `ref_territories`
--

INSERT INTO `ref_territories` (`id`, `name`) VALUES
(1, 'SEKOLAH'),
(2, 'KECAMATAN'),
(3, 'KABUPATEN/KOTA'),
(4, 'PROVINSI'),
...
--
-- Table structure for table `ref_transportations`
--

CREATE TABLE `ref_transportations` (
  `id` tinyint(3) UNSIGNED NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `ref_transportations`
--

INSERT INTO `ref_transportations` (`id`, `name`) VALUES
(1, 'JALAN KAKI'),
(2, 'SEPEDA'),
(3, 'SEPEDA MOTOR'),
(4, 'MOBIL PRIBADI'),
...
--
-- Indexes for table `ref_achievement_nums`
--
ALTER TABLE `ref_achievement_nums`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ref_achievement_types`
--
ALTER TABLE `ref_achievement_types`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `ref_creation_ctgs`
--
ALTER TABLE `ref_creation_ctgs`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ref_desires`
--
ALTER TABLE `ref_desires`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ref_disabilities`
--
ALTER TABLE `ref_disabilities`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ref_employments`
--
ALTER TABLE `ref_employments`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `ref_grade_levels`
--
ALTER TABLE `ref_grade_levels`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `kd` (`kd`),
  ADD KEY `grade_id` (`grade_id`);

--
-- Indexes for table `ref_habitations`
--
ALTER TABLE `ref_habitations`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ref_hobbies`
--
ALTER TABLE `ref_hobbies`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ref_organization_positions`
--
ALTER TABLE `ref_organization_positions`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ref_organization_types`
--
ALTER TABLE `ref_organization_types`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ref_periods`
--
ALTER TABLE `ref_periods`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `ref_province_regencies`
--
ALTER TABLE `ref_province_regencies`
  ADD PRIMARY KEY (`id`),
  ADD KEY `province_id` (`province_id`);

--
-- Indexes for table `ref_province_regency_districts`
--
ALTER TABLE `ref_province_regency_districts`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ref_salaries`
--
ALTER TABLE `ref_salaries`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ref_territories`
--
ALTER TABLE `ref_territories`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ref_transportations`
--
ALTER TABLE `ref_transportations`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `ref_achievement_nums`
--
ALTER TABLE `ref_achievement_nums`
  MODIFY `id` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `ref_achievement_types`
--
ALTER TABLE `ref_achievement_types`
...
--
-- AUTO_INCREMENT for table `ref_creation_ctgs`
--
ALTER TABLE `ref_creation_ctgs`
  MODIFY `id` tinyint(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `ref_desires`
--
ALTER TABLE `ref_desires`
  MODIFY `id` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `ref_disabilities`
--
ALTER TABLE `ref_disabilities`
  MODIFY `id` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `ref_employments`
--
ALTER TABLE `ref_employments`
  MODIFY `id` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `ref_grades`
--
ALTER TABLE `ref_grades`
  MODIFY `id` tinyint(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `ref_grade_levels`
--
ALTER TABLE `ref_grade_levels`
  MODIFY `id` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `ref_habitations`
--
ALTER TABLE `ref_habitations`
  MODIFY `id` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `ref_hobbies`
--
ALTER TABLE `ref_hobbies`
  MODIFY `id` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `ref_organization_positions`
--
ALTER TABLE `ref_organization_positions`
  MODIFY `id` tinyint(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `ref_organization_types`
--
ALTER TABLE `ref_organization_types`
  MODIFY `id` tinyint(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `ref_periods`
--
ALTER TABLE `ref_periods`
...
--
-- AUTO_INCREMENT for table `ref_province_regencies`
--
ALTER TABLE `ref_province_regencies`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9472;

--
-- AUTO_INCREMENT for table `ref_province_regency_districts`
--
ALTER TABLE `ref_province_regency_districts`
...
--
-- AUTO_INCREMENT for table `ref_salaries`
--
ALTER TABLE `ref_salaries`
  MODIFY `id` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `ref_territories`
--
ALTER TABLE `ref_territories`
  MODIFY `id` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `ref_transportations`
--
ALTER TABLE `ref_transportations`
  MODIFY `id` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
